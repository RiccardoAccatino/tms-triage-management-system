...
class PrenotazioneVisitaTest {
    ...
    void testCreazioneOggettoPrenotazione() {
        ...
        // Nota: Nel costruttore lo stato è "In Attesa" di default, ma il Service lo cambierà.
    ...
    void testPrenotazioneDirettaService() {
        ...
        // 2. Istanziamo il Service e proviamo a salvare con la nuova logica
        ...
        // 4. VERIFICA TICKET (Deve essere ACCETTATO)
        ...
        // 5. VERIFICA VISITA (Deve esistere e collegarsi al Ticket)
